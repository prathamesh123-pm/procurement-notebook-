...
import { 
  Plus, Search, Filter, Phone, MapPin, Trash2, Milk, X, Laptop, Zap, Sun, ShieldAlert, History, Edit, CheckCircle2, Box, UserCheck, Wallet, User, Printer, Truck, ShieldCheck
} from "lucide-react"
  ...
  return (
    <div className="space-y-4 max-w-full mx-auto w-full pb-10 px-2 animate-in fade-in duration-500 overflow-x-hidden">
      ...
      <div className="w-full flex flex-col items-center">
        {selectedSupplier ? (
          <div className="w-full flex flex-col items-center">
            <div className="bg-white font-sans text-slate-900 border-[1.5px] border-black rounded-sm w-full max-w-[210mm] p-4 sm:p-8 printable-report flex flex-col items-center shadow-2xl mb-10 animate-in slide-in-from-right-2 duration-300">
