            ...
            {formData.routeVisitLogs.map((entry, index) => (
              <Card key={entry.id} className="border shadow-none bg-white rounded-xl overflow-hidden border-muted-foreground/10 relative p-2.5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="col-span-2"><Input className="h-8 text-[10px] bg-muted/20 border-none rounded-lg font-black" placeholder="केंद्राचे नाव" value={entry.supplierName || ""} onChange={e => updateRouteEntry(entry.id, { supplierName: e.target.value })} /></div>
