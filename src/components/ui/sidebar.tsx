      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden rounded-r-3xl overflow-hidden"
            style={
              {
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Main navigation menu for milk procurement operations.</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-9 w-9 rounded-xl hover:bg-primary/10", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
